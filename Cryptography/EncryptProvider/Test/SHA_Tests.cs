...
namespace Cryptography.EncryptProvider.Test
{
    public class SHA_Tests
    {
        ...
        public void SHA256_Fail_Test()
        {
            ...
            //Assert
            Assert.Throws<ArgumentException>(() => EncryptProvider.Sha256(srcString));
        }
        ...
        public void SHA384_Fail_Test()
        {
            ...
            //Assert
            Assert.Throws<ArgumentException>(() => EncryptProvider.Sha384(srcString));
        }
        ...
        public void SHA512_Fail_Test()
        {
            ...
            //Assert
            Assert.Throws<ArgumentException>(() => EncryptProvider.Sha512(srcString));
        }
