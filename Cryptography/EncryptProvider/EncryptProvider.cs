...
using System.IO;
using Cryptography.EncryptProvider.Shared;
using Cryptography.EncryptProvider.Extensions;
using Cryptography.EncryptProvider.Internal;
using Cryptography.EncryptProvider.Extensions.Internal;
namespace Cryptography.EncryptProvider
{
