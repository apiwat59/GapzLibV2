...
namespace GapzLib.StringHelper.Test
{
    public class StringHelpersTests
    {
        ...
        public void IsAlphaNumeric_Valid(
            string input,
        ...
        [InlineData("lorem      ipsum dolor ", "lorem ipsum dolor")]
        [InlineData("       lorem       ipsum       dolor", "lorem ipsum dolor")]
        public void ReplaceTabsWithSpaces_Valid(
            string input,
            string expected) => Assert.Equal(expected, input.RemoveExtraSpaces());
        ...
        [InlineData("lorem\nipsum dolor\n", "lorem ipsum dolor")]
        public void ReplaceNewLinesWithSpaces_Valid(
            string input,
            string expected) => Assert.Equal(expected, input.RemoveExtraSpaces());
        ...
        [InlineData("   lorem\nipsum  dolor\n  ", "lorem ipsum dolor")]
        [InlineData("\tlorem\nipsum    dolor\n     ", "lorem ipsum dolor")]
        public void ToCleanString_Valid(
            string input,
            string expected) => Assert.Equal(expected, input.RemoveExtraSpaces());
        ...
        [InlineData("\tlorem\nipsum.    dolor\n     ", "LID")]
        public void ToNcharAbbreviation_Valid(
            string input,
        ...
        [InlineData("lorem ipsum. dolor", "Lorem ipsum. Dolor.")]
        [InlineData("\tlorem\nipsum.    dolor\n     ", "Lorem ipsum. Dolor.")]
        public void ToSentenceCase_Valid(
            string input,
        ...
        public void ToSummarisedTextRight_Valid(
            string input,
            int length,
        ...
        public void ToStringArrayFromDelimitedString_Valid(
            string input,
            string[] expected) => Assert.Equal(expected, input.ToStringArrayFromDelimitedString(','));
        ...
        public void ToUrlFriendly_Valid(
            string input,
        ...
        [InlineData("\tlorem\nipsum    dolor\n     ", "lorem")]
        public void GetFirstLongestWord_Valid(
            string input,
        ...
        public void RemoveNumberOfCharsAtBegining_Valid(
            string input,
            int n,
        ...
        public void HowManyOccurrences_String_Valid(
            string input,
            string c,
            int expected) => Assert.Equal(expected, input.HowManyOccurrences(c));
        ...
        [InlineData(null, 0)]
        [InlineData("22se2", 3)]
        public void FindNumberOfDigits_Valid(
            string input,
        ...
        [InlineData("", 'a', "")]
        public void ReplaceNonASCIICharsWith_Valid(
            string input,
            char c,
        ...
        public void ReplaceDoubleQuotesWithSingle_Valid(
            string input,
        ...
        public void NullIfEqualTo_Valid(
            string input,
            string search,
            string expected) => Assert.Equal(expected, input.NullIfEqualTo(search));

        [Theory]
        [InlineData(null, "..", "..")]
        [InlineData("", "--", "--")]
        [InlineData("abcd", "..", "abcd..")]
        public void AddToEndIfMissed_Valid(
            string input,
            string value,
        ...
        public void RemoveNumberOfCharsAtEnd_Valid(
            string input,
            int n,
            string expected) => Assert.Equal(expected, input.RemoveNumberOfCharsAtEnd(n));

        [Theory]
        [InlineData(null, null)]
        [InlineData("", "")]
        [InlineData("MTIzNDU=", "12345")]
        public void DecodeBase64_Valid(
            string input,
            string expected) => Assert.Equal(expected, input.DecodeBase64());
    }
}
